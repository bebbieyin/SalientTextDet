...
from modeling.swin_fpn.fpn import FPN, LastLevelMaxPool, LastLevelP6P7
...
class SwinTransformer(Backbone):
    ...
    def forward(self, x):
        ...
        # # original swin output, shape [BATCH_SIZE, 786]
        # xout1 = norm_layer(x_out)
        # xout1 = self.avgpool(xout1.transpose(1, 2))
        # xout1 = torch.flatten(xout1, 1)
        # print(xout1.shape)
